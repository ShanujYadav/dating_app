...
const LanguageScreen = () => {
    ...
    const updateLanguages = async () => {
        const UPDATE_USER_LANGUAGES_MUTATION = `
          mutation UpdateUserDrinking($userId: String!, $languages: String!) {
            updateShinkUser(input: { userId: $userId, languages: $languages }) {
              userId
              languages
            }
          }
        ...
        try {
            const response = await fetch('https://6zdkqxsh5nb57gljtisvt3rxre.appsync-api.ap-south-1.amazonaws.com/graphql', {
                ...
                body: JSON.stringify({
                    query: UPDATE_USER_LANGUAGES_MUTATION,
                    variables: { userId: '8', work: selectedLanguages },
                }),
            });
            const data = await response.json();
            console.log('API Response: ', data);
            ...
            console.error('Error while updating user languages: ', error);
        }
    };
    ...
    const handleNextButtonPressed = async () => {
        if (selectedLanguages !== '') {
            ...
            console.log('Selected languages sent to backend successfully');
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={styles.subTitleTextStyle}>
                Write your language, which type you know.</Text>
            <TextInput placeholder="Type here e.g: English, Hindi, Sanskrit"
                placeholderTextColor={'#979797'}
                value={selectedLanguages}
                onChangeText={(value) => setSelectedLanguages(value)}
